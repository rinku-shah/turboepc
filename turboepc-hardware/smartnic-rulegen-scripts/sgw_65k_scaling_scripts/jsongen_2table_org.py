...
with open('sgw2.p4cfg') as f:
  data = json.load(f)

# Output: {'name': 'Bob', 'languages': ['English', 'Fench']}
print(data)
# print(data['tables']['service_req_uekey_sgwteid_map'])
table_data = data['tables']['ingress::ctxt_setup_uekey_sgwteid_map'];
print table_data['rules'][0]['action']['data']
print table_data['rules'][0]['match']['initial_ctxt_setup_resp.ue_key']
ue_key = table_data['rules'][0]['match']['initial_ctxt_setup_resp.ue_key']['value']
...
for i in range(1,50000):
    ...
    # print tmp_ue_key
    ue_ser_req={}
    ue_ser_req['initial_ctxt_setup_resp.ue_key'] = tmp_ue_key
    rules={}
...
print "\n"
print start
with open('data2.p4cfg', 'w') as outfile:
    json.dump(l, outfile)
