...
public class FR{
    ...
    //  @vikas: parallel code made modular : we need to populate these tables on DGW itself only
     public void populate_lookup_if_tables(boolean removeRule,int lookup_flag,ApplicationId appId,FlowRuleService flowRuleService,DeviceId switchId,int ue_key){
        ...
        // ******************************************************   LOOKUP TBALES for if statements **************************************************
             ...
             //lookup_flag tells which tables to be populated either lb1_ub1 tables or lb2_ub2 tables lb3_ub3 tables
             if(lookup_flag==1){
