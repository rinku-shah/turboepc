            ...
            if(payload.contains(Constants.SEPARATOR)){
                ...
                switch(Integer.toString(type)){
                    ...
                    case Constants.UE_SERVICE_REQUEST:
                        ...
                        // @vikas @parallel design : hardcoding here value as 4 as SGW1_3 is connected on port 4 of DGW
                        int outPort1 = Constants.DGW_to_SGW1_3_Port;
