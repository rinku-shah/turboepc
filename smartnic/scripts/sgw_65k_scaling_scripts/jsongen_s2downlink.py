...
with open('sgw_s2downlink.json') as f:
  data = json.load(f)

# Output: {'name': 'Bob', 'languages': ['English', 'Fench']}
print(data)
# print(data['tables']['service_req_ip_op_tun_s2_downlink'])
table_data = data['tables']['ip_op_tun_s2_downlink'];
...
tmp_rules["rules"] = l
table_name1 = {}
table_name1["ingress::service_req_ip_op_tun_s2_downlink"] = tmp_rules;
start={}
start["tables"]= table_name1
print "\n"
print start
with open('data7.p4cfg', 'w') as outfile:
    json.dump(l, outfile)
