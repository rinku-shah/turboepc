...
with open('sgw3.p4cfg') as f:
  data = json.load(f)

# Output: {'name': 'Bob', 'languages': ['English', 'Fench']}
print(data)
# print(data['tables']['service_req_uekey_sgwteid_map'])
table_data = data['tables']['egress::ctxt_release_uekey_sgwteid_map'];
...
tmp_rules["rules"] = l
table_name1 = {}
table_name1["ingress::ctxt_release_uekey_sgwteid_map"] = tmp_rules;
start={}
start["tables"]= table_name1
print "\n"
print start
with open('data3.p4cfg', 'w') as outfile:
    json.dump(l, outfile)
