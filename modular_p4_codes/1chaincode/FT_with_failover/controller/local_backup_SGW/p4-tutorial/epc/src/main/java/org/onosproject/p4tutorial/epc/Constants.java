...
public class Constants {
	...
	// @FT_with_failover : the local ONOS of SGW1_2 replies to RAN. 
...
//			final static String STARTING_UE_IP_1 = "10.0.0.1"; //"10.129.41.103";
		...
		//=====================================
			...
			// @FT_with_failover : SGW1_2 (backup SGW) to PGW Port 
			final static int SGW_to_PGW_Port = 3;
			// @FT_with_failover : primary_to_backup_SGW_Port indicates the physical port of SGW1_2 to which SGW1_1 is connected
