...
public class FR{
    ...
    public void populate_dgw_failover_table(ApplicationId appId,FlowRuleService flowRuleService,DeviceId switchId,int metakey, int dgw_egress_port){

        PiTableId tunnelIngressTableId = PiTableId.of("c_ingress.toggle_primary_backup_sgw");
        PiMatchFieldId ueKeyFieldId = PiMatchFieldId.of("meta.metakey");
        PiCriterion match = PiCriterion.builder()
                .matchExact(ueKeyFieldId, metakey)
                .build();

        PiActionId ingressActionId = PiActionId.of("c_ingress.select_primary_backup_sgw_port");
        PiActionParam ueStateParam = new PiActionParam(PiActionParamId.of("egress_port_dgw"), dgw_egress_port);
