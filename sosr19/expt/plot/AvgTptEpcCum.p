...
plot newhistogram fs pattern 1, 'cent-wo-data.dat' using 2:xtic(1) title 'Traditional EPC'  lc rgb 'red' lw 2  ,\
   'offload-wo-data.dat' using 2 title 'TurboEPC'  lc rgb 'black' lw 2 #, \
