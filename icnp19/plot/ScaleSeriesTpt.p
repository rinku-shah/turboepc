...
plot newhistogram fs pattern 1, 'series.dat' using 2:xtic(1) title '1-sgw' lc rgb 'red' lw 2  ,\
  'series.dat' using 5 title '2-sgw' lc rgb 'black' lw 2  , \
 'series.dat' using 8 title '3-sgw' lc rgb 'blue' lw 2
