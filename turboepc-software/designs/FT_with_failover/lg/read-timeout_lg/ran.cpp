...
#define NO_EPOCH 8
#define INST_ARR_LEN 400
#define INST_PERIOD 5 // period in secs
...
int FAIL = 600; //Time in secs after which thread sleep 
int WAKEUP = 0; //Time for which all threads sleep after primary switch failure
	...
	while(curTime < endTime){
		...
		switch(traffic_type){
			...
			case 4: setUpTunnel_t = true;
					...
					loop2 = 90;   //inner loop---service-req
					break;
