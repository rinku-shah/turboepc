...
/* egress::tmpvar (2B) */
struct pif_header_egress__tmpvar {
    unsigned int tmpUdpPort:16;
};

/* egress::tmpvar field accessor macros */
#define PIF_HEADER_GET_egress__tmpvar___tmpUdpPort(_hdr_p) (((_hdr_p)->tmpUdpPort)) /* egress::tmpvar.tmpUdpPort [16;0] */

#define PIF_HEADER_SET_egress__tmpvar___tmpUdpPort(_hdr_p, _val) \
    do { \
        (_hdr_p)->tmpUdpPort = (unsigned)(((_val))); \
    } while (0) /* egress::tmpvar.tmpUdpPort[16;0] */
...
#define PIF_HEADER_GET_scalars____padding_0(_hdr_p) (((_hdr_p)->_padding_0)) /* scalars._padding_0 [30;0] */

#define PIF_HEADER_SET_scalars____padding_0(_hdr_p, _val) \
    do { \
        (_hdr_p)->_padding_0 = (unsigned)(((_val))); \
    } while (0) /* scalars._padding_0[30;0] */
