...
int mix_num=11;	//choose the traffix mix from above traffic_options -> {0,1,2}  // 11 means only attach request will be sent
float a_prob = 0;
float s_prob = 0;
...
void* multithreading_func(void *arg){
	...
	Client user(threadId+500), sink_user(threadId+500);
