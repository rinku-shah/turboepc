...
vector<string> setup_tunnel_ho(UserEquipment&, Client&, bool);
void detach_ue(UserEquipment&, Client&, int, string, string, string);
void ue_context_release(UserEquipment&, Client&, int, string, string, string, int, bool,bool);
string ue_service_request(UserEquipment&, Client&, int, string,bool);
