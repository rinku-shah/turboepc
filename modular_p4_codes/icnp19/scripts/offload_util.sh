...
sh cpu_util.sh $1 $2 $sg1 sgw1_util.txt tmp_s1 $3 "^%Cpu24 \|^%Cpu25 " & 

sh cpu_util.sh $1 $2 $sg2 sgw2_util.txt tmp_s2 $3 "^%Cpu26 \|^%Cpu27 " & 

sh cpu_util.sh $1 $2 $sg3 sgw3_util.txt tmp_s3 $3 "^%Cpu28 \|^%Cpu29 " & 

sh cpu_util.sh $1 $2 $sg4 sgw4_util.txt tmp_s4 $3 "^%Cpu30 \|^%Cpu31 " & 
