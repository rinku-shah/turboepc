...
control c_ingress(inout headers hdr,
   ...
   table ip_op_tun_s1_uplink{
    ...
    action populate_tun_egress_s3_uplink(bit<9> egress_port_s3){
        ...
        else if(standard_metadata.ingress_port==1 || standard_metadata.ingress_port==2 || standard_metadata.ingress_port==3 || standard_metadata.ingress_port==4  || standard_metadata.ingress_port==5  || standard_metadata.ingress_port==6 || standard_metadata.ingress_port==7  || standard_metadata.ingress_port==8){
                   ...
                   if(standard_metadata.ingress_port==1 ){
                            ...
                            // UDP means control traffic
                                ...
                                if(hdr.data.epc_traffic_code == 14){
                                    ...
                                    // @vikas: in case of modular p4 code we are doing table lookup to decide whether to forward the packet on link 2(SGW1) or link3(SGW2) or link4(SGW3)
                                    ...
                                    else if(uekey_lookup_lb3_ub3.apply().hit){
                    ...
                    else if(standard_metadata.ingress_port==2 || standard_metadata.ingress_port==3 || standard_metadata.ingress_port==4){
