...
ONOS_APPS=drivers.bmv2,p4tutorial.pipeconf,p4tutorial.pipeconf_sgw1,p4tutorial.pipeconf_sgw2,p4tutorial.pipeconf_pgw NO_BUCKD=1 onos-buck run onos-local -- clean
...
# for ft uncomment the below line
#ONOS_APPS=drivers.bmv2,p4tutorial.pipeconf,p4tutorial.pipeconf_sgw1,p4tutorial.pipeconf_sgw2,p4tutorial.pipeconf_pgw,p4tutorial.epc NO_BUCKD=1 onos-buck run onos-local -- clean
