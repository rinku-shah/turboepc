...
public class FR{
     ...
     */
     ...
     public void populate_uekey_sgwteid_map(ApplicationId appId,FlowRuleService flowRuleService,DeviceId switchId,int ue_key, int sgw_teid){
     ...
     public void populate_uekey_uestate_map(ApplicationId appId,FlowRuleService flowRuleService,DeviceId switchId,int ue_key, int ue_state){
     ...
     public void populate_uekey_guti_map(ApplicationId appId,FlowRuleService flowRuleService,DeviceId switchId,int ue_key, int guti){
