...
plot newhistogram fs pattern 1, 'cent-wo-data.dat' using 3:xtic(1) title 'Centralized mode' lc rgb 'red' lw 2  ,\
    'offload-wo-data.dat' using 3 title 'Offload mode' lc rgb 'black' lw 2  #, \
