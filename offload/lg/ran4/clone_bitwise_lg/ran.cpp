...
void* multithreading_func(void *arg){
	...
	Client user(threadId+400), sink_user(threadId+400);
	...
	while(curTime < endTime){
		...
		switch(traffic_type){
			...
			case 4: setUpTunnel_t = true;
					...
					ueServiceRequest_t = true;
					dataTime = 1;
					//loop1 50 75;    //outer loop---attach
					//loop2 50125;   //inner loop---service-req
					loop1 = 5;    //outer loop---attach
					loop2 = 95;   //inner loop---service-req
					break;
